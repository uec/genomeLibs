...
//	protected boolean outputReads = false;
	...
	@Option(name="-regionFile",usage="region file (gtf) containing regions to output")
	protected String regionFile = null;
	...
	throws Exception {
		...
		ChromFeatures feats = (this.regionFile==null) ? null : new ChromFeatures(this.regionFile, true);
		if (chrs.size()==0) chrs = MethylDbUtils.CHROMS;
		for (final String chr : chrs)
		{
			
			List<GenomicRange> grs = new ArrayList<GenomicRange>(5000);
			if (this.regionFile==null)
			{
				grs.add(new GenomicRange(chr, 0, 0));
			}
			else
			{
				Iterator it = feats.featureIterator(feats.chrom_from_public_str(chr));
				while (it.hasNext())
				{
					GFFRecord rec = (GFFRecord)it.next();
					grs.add(new GenomicRange(chr, rec.getStart(),rec.getEnd()));
				}
			}
			...
			for (final String fn : stringArgs)
			{
				...
				for (GenomicRange gr : grs)
				{
				
				CloseableIterator<SAMRecord> chrIt = inputSam.query(chr, gr.getStart(), gr.getEnd(), false);
...
//		}
		...
		String out = String.format("%s\t%d\t%d\t%s\t%d\t%s\t%d\t%d\t%s\t", 
				...
				s,
				e,
				String.format("r%d%s%d.%d", s,strand, (consensusCpg==null) ? 0 : consensusCpg.totalReads,score),
				score,
	...
	protected static String methToColor(double meth)
	{
		...
		else if (meth > 0.5)
		{
			...
			switch (dec)
			{
			case 0: case 1: color = "153,153,153"; break;
//			case 2: case 3: case 4: case 5: color = "255,153,153"; break;
//			case 6: case 7: color = "255,102,102"; break;
//			case 8: case 9: case 10: color = "255,0,0"; break;
			case 2: case 3: case 4: case 5: color = "204,102,102"; break;
			case 6: case 7: color = "255,102,102"; break;
			case 8: case 9: case 10: color = "153,0,0"; break;
		...
		else
		{
			...
			{
			case 0: case 1: color = "153,153,153"; break;
//			case 2: case 3: case 4: case 5: color = "153,255,153"; break;
//			case 6: case 7: color = "102,255,102"; break;
//			case 8: case 9: case 10: color = "0,255,0"; break;
			case 2: case 3: case 4: case 5: color = "153,204,153"; break;
			case 6: case 7: color = "102,255,102"; break;
			case 8: case 9: case 10: color = "0,102,0"; break;
			default: System.err.println("Got illegal color decile: " + dec); System.exit(1); break;
			}
		}
