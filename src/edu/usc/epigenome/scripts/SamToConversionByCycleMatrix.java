...
public class SamToConversionByCycleMatrix {

	final private static String prefix = "methylCGsRich_";
	final private static String USAGE = "SamToConversionByCycleMatrix [opts] sampleName file1.bam file2.bam ...";
...
//	protected boolean outputReads = false;
	...
	throws Exception
	{
		new SamToConversionByCycleMatrix().doMain(args);
	}
