...
public class SamToMethyldbOnlineCpgLessMem {
	 ...
	 */
		...
		final private static String USAGE = "SamToMethyldbOnlineCpgLessMem [opts] sampleName snpfile2.txt file1.bam file2.bam ...";
...
//		protected double minHcphFrac = 0;
		...
		throws Exception
		{
			new SamToMethyldbOnlineCpgLessMem().doMain(args);
		}
