...
public abstract class CpgWalkerMultisample_DEPR implements TabularOutput,ActionListener {

	public CpgWalkerParams walkParams = null;
	
	protected CpgWalker[] walkers = null;
	
	public CpgWalkerMultisample_DEPR(CpgWalkerParams inWalkParams, int numSamples) {
