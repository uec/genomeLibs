...
public class CpgWalkerMultisampleMethRange_DEPR extends CpgWalkerMultisample_DEPR {
	...
	public CpgWalkerMultisampleMethRange_DEPR(CpgWalkerParams inWalkParams,
	 ...
	 * a flag if the individual CpG itself follows the trend.
	 */
	@Override
