...
public class MethylDbQuerier {
	...
	public static String connStrCytosine = DEFAULT_CONN_STR;
...
//			1 row in set (0.11 sec)
	...
	protected MethylDbQuerier.HelperOutput sqlWhereSecHelperAsm(PreparedStatement prep, String asName, int curInd)
	throws SQLException
	{
		String asSec = (asName==null) ? "" : (asName+".");
