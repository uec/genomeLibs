 ...
 * @author benb
 *
 * Interface for bisulfite cytosine (or pair).  To be the base API for AlignmentPosSnpsBisulfiteConverted
 * and CpgPair
 */

public class BisulfiteCytosine {
	 ...
	 * @param cpgB
	 */
	public BisulfiteCytosine(AlignmentPosSnpsBisulfiteConverted cpgA,
...
//		out += cpgB.gffLine();
	...
	public static String csvStats(Collection<BisulfiteCytosine> cpgs)
	{
...
//		out[ind++] = (double)this.getStrandMismatch();
	...
	public static double[] stats(Collection<BisulfiteCytosine> cpgs)
	{
		double[] totals = null;
		double[] ns = null; // So we can have NaNs
		
		for ( BisulfiteCytosine cpg : cpgs)
		{
