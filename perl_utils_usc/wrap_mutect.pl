...
my $MUTECT = "$SOFTWAREROOT/mutect/default/mutect.jar";
my $JAVA = "$SOFTWAREROOT/java/default_java6/bin/java -Xmx7G";
my $SAMTOOLS = "$SOFTWAREROOT/samtools/samtools";
my $JAVA7 = "$SOFTWAREROOT/java/default_java7/bin/java -Xmx$ram" . "G";
my $GATKSNP = "$SOFTWAREROOT/GATK2/default/GenomeAnalysisTK.jar";


## define required file by provided reference genome
if($ref =~/hg18/){
	$dbsnp="$SOFTWAREROOT/bissnp/genomic_data/dbsnp_135.hg18.sort.vcf";
	$cosmic = "$GENOMEROOT/genomic-data-misc/COSMIC/hg18_cosmic_v54_120711.vcf";
	...
	$interval = "$GENOMEROOT/genomic-data-misc/agilentSureSelect/S04380110_Regions.bed" unless $interval;
	$cosmic = "$GENOMEROOT/genomic-data-misc/COSMIC/b37_cosmic_v54_120711.fixed.vcf";
	$dbsnp="$GENOMEROOT/genomic-data-misc/dbsnp/dbsnp_138.hg19.vcf";
	...
	$dbsnp = "$GENOMEROOT/genomic-data-misc/dbsnp/dbsnp_135.hg19.sort.vcf";
	$interval = "$GENOMEROOT/genomic-data-misc/agilentSureSelect/S04380110_Regions.bed" unless $interval;
	$cosmic = "$GENOMEROOT/genomic-data-misc/COSMIC/b37_cosmic_v54_120711.fixed.vcf";
}	
elsif($ref =~/37/ ){
	...
	$interval = "$GENOMEROOT/genomic-data-misc/agilentSureSelect/S04380110_Regions.bed" unless $interval;
	$cosmic = "$GENOMEROOT/genomic-data-misc/COSMIC/b37_cosmic_v54_120711.vcf";
