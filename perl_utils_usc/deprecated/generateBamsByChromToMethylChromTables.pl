...
foreach my $region (@regions)
{
    ...
    my $cmd = "export CLASSPATH=$SOFTWAREROOT/genomeLibs.jar:$SOFTWAREROOT/UscKeck.jar:$SOFTWAREROOT/sam-1.26.jar:$SOFTWAREROOT/biojava-live_1.6/apps-live.jar:$SOFTWAREROOT/biojava-live_1.6/biojava-live.jar:$SOFTWAREROOT/biojava-live_1.6/bytecode.jar:$SOFTWAREROOT/commons-math-1.1.jar:$SOFTWAREROOT/biojava-live_1.6/commons-cli.jar:$SOFTWAREROOT/biojava-live_1.6/commons-collections-2.1.jar:$SOFTWAREROOT/biojava-live_1.6/commons-dbcp-1.1.jar:$SOFTWAREROOT/biojava-live_1.6/commons-pool-1.1.jar:$SOFTWAREROOT/biojava-live_1.6/demos-live.jar:$SOFTWAREROOT/biojava-live_1.6/jgrapht-jdk1.5.jar:$SOFTWAREROOT/biojava-live_1.6/junit-4.4.jar\n";
